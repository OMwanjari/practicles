...
def extract_skills(doc):
    ...
    skills = set(["Python", "Java", "C++", "JavaScript", "HTML", "CSS", "SQL", "React", "Angular", "Node.js",
                  ...
                  "Excel", "Data Analysis", "Machine Learning", "Deep Learning", "人工智能", "Natural Language Processing",
                  "Computer Vision", "Blockchain", "IoT", "Cybersecurity", "Penetration Testing", "Network Security",
                  "Cloud Security", "DevOps", "Agile", "Scrum"])
    found_skills = set()
    for token in doc:
...
def create_dashboard(df):
    ...
    display_df = filtered_df[['name', 'degree', 'cgpa', 'marks_10th', 'marks_12th', 'tech_skills', 'soft_skills']]
    st.dataframe(display_df.style.format({'cgpa': "{:.2f}", 'marks_10th': "{:.2f}", 'marks_12th': "{:.2f}"}))
